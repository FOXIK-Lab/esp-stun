...
#define WIFI_MENU_ITEM_COUNT 6
static const char* wifiMenuItems[] = {"Connect", "Deauther", "Beacon", "Portal", "Wardrvng", "Packets"};

inline void displayWiFiMenu(DisplayType &display, byte menuIndex) {
